    ...
    */
    ...
    fun handleValidationError(ex: MethodArgumentNotValidException): ResponseEntity<ErrorResponse> {
        ...
        return ResponseEntity.badRequest()
            .body(ErrorResponse(BAD_REQUEST, "Validation failed with ${ex.bindingResult.errorCount} error(s)", vErrors))
    }
...
data class ErrorResponse(
    ...
    val message: String,
    val details: Map<String, @Contextual @Serializable(with = DynamicLookupSerializer::class)
        Any>? = null
)
