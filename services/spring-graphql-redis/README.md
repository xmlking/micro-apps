...
1. (optional) Install [RedisInsight-v2](https://redis.com/redis-enterprise/redis-insight/) app
...
```shell
gradle :services:spring-redis-graphql:test
```
