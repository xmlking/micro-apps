...
class AccountController(private val accountService: AccountService) {
    ...
    suspend fun createPerson(
        @Valid @RequestBody
        person: PersonDto
    ): PersonEntity = accountService.createPerson(person)
    ...
    @PutMapping(value = ["/{id}"])
    @ResponseStatus(HttpStatus.OK)
    suspend fun updatePerson(@PathVariable id: String, @Valid @RequestBody person: PersonDto): PersonEntity { // ktlint-disable annotation
